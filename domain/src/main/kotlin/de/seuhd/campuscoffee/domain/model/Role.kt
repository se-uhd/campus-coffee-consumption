 ...
 * `MODERATOR` grant and the `Set<Role>` collection are dropped): [USER] is a regular SE@UHD user who
 * tracks their own coffee count, and [ADMIN] additionally administers users (create, edit, deactivate,
