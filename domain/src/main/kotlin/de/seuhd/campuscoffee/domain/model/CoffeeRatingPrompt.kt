 ...
 * @property defaultBeanId the bean to preselect: the current window's already-cast vote, else the most
 *   recently purchased bean, else null (the SPA then picks the first selectable bean)
