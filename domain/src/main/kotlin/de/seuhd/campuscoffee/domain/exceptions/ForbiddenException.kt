 ...
 * changing another member's coffee count or editing an account they do not own. This is an *authorization*
 ...
 *
 * The decision is made in the domain by comparing the acting [User][de.seuhd.campuscoffee.domain.model.objects.User]
