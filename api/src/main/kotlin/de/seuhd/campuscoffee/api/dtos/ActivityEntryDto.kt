...
/**
 * Response DTO for one row of an activity feed (a member's or the kitty's). [id] is a stable per-entry key
 ...
 * **admin** views of a split bean purchase (its member-funded and kitty-funded portions): both the member's
 * PRIVATE_EXPENSE row and the kitty history's KITTY_EXPENSE row carry them. The member-serving read
