...
/**
 * The [ActorProviderService] adapter, reading the authenticated principal from Spring Security's
 * `SecurityContext`. Returns the principal's login name (a user authenticated by their capability token,
 ...
 */
@Component
class ActorProviderServiceImpl : ActorProviderService {
