 ...
 * on the way out. The entity's `version` column (data-layer optimistic locking) has no domain counterpart,
 * so it is left to JPA on insert and preserved on update.
 */
