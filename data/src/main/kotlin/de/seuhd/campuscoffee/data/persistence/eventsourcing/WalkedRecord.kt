...
/**
 * One event interpreted by [ActivityWalk]: the subject user it concerns and its signed effect on that
 ...
 */
internal data class WalkedRecord(
 ...
 */
internal fun WalkedRecord.toUserEntry(): ActivityEntry =
    ActivityEntry(
        type =
            when (kind) {
 ...
 */
internal fun WalkedRecord.toKittyEntry(): ActivityEntry =
    ActivityEntry(
        type =
            when (kind) {
                WalkedKind.DEPOSIT -> ActivityEntryType.DEPOSIT
 ...
 */
internal fun WalkedRecord.toGlobalEntry(subjectLoginById: Map<UUID, String>): GlobalActivityEntry =
    GlobalActivityEntry(
        type =
            when (kind) {
                WalkedKind.CONSUMPTION -> ActivityEntryType.CONSUMPTION
