 ...
 * activity table). A single shared [ActivityWalk] backs all three feeds: it walks a user's bounded stream
...
class ActivityDataServiceImpl(
    ...
    override fun globalActivity(): List<GlobalActivityEntry> {
        ...
        return eventRepository
            ...
            .filter { it.userEffect != null || it.kittyEffect != null || it.kind == WalkedKind.PRICE_CHANGE }
