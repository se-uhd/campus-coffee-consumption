 ...
 * which resolves (never rejects) even on a load failure, so the navigation is never cancelled: a failed
 * preload simply lands on the page with the store's retry affordance shown.
 */
